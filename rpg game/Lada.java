...
public class Lada extends Playabl {
    ...
    public Lada(int x, int y){
        super("LADA", x,y, 400,400,190,270,110, 100, 100, 90, 100, new ImageIcon("placeholdercat.gif"),new ImageIcon("placeholdercat.gif"),new ImageIcon("placeholdercat.gif"), new ImageIcon("placeholdercat.gif"), new ImageIcon("placeholdercat.gif"), new Tuna(x, y));
